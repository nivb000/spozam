...
import { useGetSongDetailsQuery, useGetSongRelatedQuery } from "../services/shazamCore.service";
...
export const SongDetails = () => {
    ...
    const { data:songs , isFetching: isFetchingRelatedSongs, error } = useGetSongRelatedQuery({ songId })
    ...
    return <div className="flex flex-col">
        ...
        <div className="mb-10">
            ...
            <div className="mt-5">
                ...
                )) : <p key={idx} className="text-gray-400 text-base my-1">Sorry no lyrics available for this song</p>}
            </div>
        </div>
